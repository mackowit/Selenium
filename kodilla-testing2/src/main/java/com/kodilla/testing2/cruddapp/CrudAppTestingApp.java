...
public class CrudAppTestingApp {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://mackowit.github.io");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");

        WebElement textAreaSearchField = driver.findElement(By.xpath(XPATH_TEXTAREA));
        textAreaSearchField.sendKeys("The robotic content");
