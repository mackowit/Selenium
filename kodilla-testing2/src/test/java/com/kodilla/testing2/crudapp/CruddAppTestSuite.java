...
public class CruddAppTestSuite {
    private static final String BASE_URL = "https://mackowit.github.io/";
    ...
    private String createCruddTestTask() throws InterruptedException {
    ...
    private boolean checkTaskExistsInTrello(String taskName)throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mackowit@o2.pl");
        driverTrello.findElement(By.id("login")).submit();

        Thread.sleep(5000);

        driverTrello.findElement(By.id("password")).sendKeys("greendrake");
    ...
    @Test
    public void shoulldCreateTrelloCard() throws InterruptedException {
        String taskName = createCruddTestTask();
